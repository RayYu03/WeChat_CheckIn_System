...
if  __name__ == '__main__' :
    #待导入学生信息文件
    filename =[u'Externalfiles/软件工程1401.csv',u'Externalfiles/软件工程1402.csv',u'Externalfiles/软件工程1403.csv',u'Externalfiles/软件工程1404.csv',u'Externalfiles/软件工程1405.csv',u'Externalfiles/计算机科学与技术1401.csv']
    #目标文件
